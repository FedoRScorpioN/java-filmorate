...
class FilmStorageTest {
    ...
    private final Film firstFilm = new Film(1,
            "film1 name",
            "film1 description",
    ...
    private final Film secondFilm = new Film(2,
            "film2 name",
            "film2 description",
    ...
    public void getFilmByIdTest() {
        filmStorage.createFilms(film);
        Film dbFilm = filmStorage.getByIdFilms(1);
        assertThat(dbFilm).hasFieldOrPropertyWithValue("id", 1);
    }

    @Test
    public void updateFilmTest() {
        Film added = filmStorage.createFilms(film);
        added.setName("film updated");
        filmStorage.updateFilms(added);
        Film dbFilm = filmStorage.getByIdFilms(added.getId());
        assertThat(dbFilm).hasFieldOrPropertyWithValue("name", "film updated");
    }

    @Test
    public void deleteFilmTest() {
        Film addedFilm1 = filmStorage.createFilms(firstFilm);
        Film addedFilm2 = filmStorage.createFilms(secondFilm);
